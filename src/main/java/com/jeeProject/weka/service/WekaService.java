...
import com.esgi.ml.ModelClassifier;
import com.esgi.ml.ModelGenerator;
...
public class WekaService {
    ...
    public Modele ExecuteModel(Modele modele) throws Exception {
        ...
        modele.setNb_instance((int)this.getModelGenerator().numInstances);
        modele.setCorrect_instances(this.getModelGenerator().correct);
        modele.setIncorrect_instances(this.getModelGenerator().incorrect);
